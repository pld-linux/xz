...
# Source0-md5:	875022c88a8637370368dbb96a1ed811
...
%{_mandir}/man1/unxz.1*
%{_mandir}/man1/xz*.1*
%lang(ar) %{_mandir}/ar/man1/lz*.1*
%lang(ar) %{_mandir}/ar/man1/unlzma.1*
%lang(ar) %{_mandir}/ar/man1/unxz.1*
%lang(ar) %{_mandir}/ar/man1/xz*.1*
...
%lang(it) %{_mandir}/it/man1/lz*.1*
%lang(it) %{_mandir}/it/man1/unlzma.1*
%lang(it) %{_mandir}/it/man1/unxz.1*
%lang(it) %{_mandir}/it/man1/xz*.1*
...
%lang(sr) %{_mandir}/sr/man1/lz*.1*
%lang(sr) %{_mandir}/sr/man1/unlzma.1*
%lang(sr) %{_mandir}/sr/man1/unxz.1*
%lang(sr) %{_mandir}/sr/man1/xz*.1*
%lang(sv) %{_mandir}/sv/man1/lz*.1*
%lang(sv) %{_mandir}/sv/man1/unlzma.1*
%lang(sv) %{_mandir}/sv/man1/unxz.1*
%lang(sv) %{_mandir}/sv/man1/xz*.1*
